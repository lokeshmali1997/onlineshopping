<%@ Page Title="" Language="C#" MasterPageFile="~/MakePayment.master" AutoEventWireup="true" CodeFile="MDebitCard.aspx.cs" Inherits="_Default" %>
...
<ul class="">
 <li style=" margin-bottom:50px; border-bottom:1px solid #ddd; padding-bottom:5px">Pay Using Debit Card</li>
 <li>
