<%@ Page Title="" Language="C#" MasterPageFile="~/KapdeWala.master" AutoEventWireup="true" CodeFile="SearchPage.aspx.cs" Inherits="_Default" EnableEventValidation="true" %>
  ...
  <li>Italy</li>
     ...
     <div class="col-sm-10" style=" margin:20px 0px 0px 10px">
       ...
       <label class="sortbyddl">Sort by :</label><asp:DropDownList ID="DropDownList1"  
         ...
         <asp:Label ID="lblsearch" runat="server" CommandName="ViewDetail" Text='<%# Bind("Product_Name") %>' Visible="False"></asp:Label>
          ...
          <ItemTemplate>
                 ...
                 <div class="col-sm-3 " style=" margin-top:20px;box-shadow: 2px 2px 2px 2px #ddd">
                    ...
                    <asp:Label ID ="lbloff" runat="server">&#37;Off</asp:Label></em></li>
                      ...
                      <asp:Label ID="lblsearch" runat="server" CommandName="ViewDetail" Text='<%# Bind("Product_Id") %>' Visible="False"></asp:Label>
                    </div>
...
<ul>
       ...
       <asp:Label ID="lbldatanotfound"  runat="server" Text="Data not found" Visible="false"></asp:Label>
           <asp:Button ID="btndatanotfound" runat="server" Text="Continue" Visible="false" 
