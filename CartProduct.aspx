<%@ Page Title="" Language="C#" MasterPageFile="~/KapdeWala.master" AutoEventWireup="true" CodeFile="CartProduct.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<style>
.col-sm-8>.col-sm-4>ul{ list-style-type:none; margin-top:30px;}
.col-sm-8>.col-sm-4>ul>li{ margin-top:5px;}
.col-sm-4>ul>li{ margin-top:10px}
...
<h3 style=" color:#000; margin-bottom:50px; margin-top:20px;">Add To Add</h3>
...
<div class="col-sm-2">
    <asp:Image ID="imgproductimg" ImageUrl='<%# Bind("Order_Image") %>' runat="server" width="90px" Height="130px" /></div>
<div class="col-sm-4">
     <ul>
      <li><asp:Label ID="lblproductname" class="pname" runat="server" Text='<%# Bind("Order_Name") %>'/></li>
      <%--<li><label></label><asp:Label ID="lblproductcolour" class="pcolor" runat="server" Text='<%# Bind("Order_Colour") %>'/></li>--%>
      <li><asp:Label ID="lblproductprice" class="pprice" runat="server" Text='<%# Bind("Order_Price") %>'/><span><del><asp:Label ID="lblproductdisprice" class="pdprice" runat="server" Text='<%# Bind("Order_Dis_Price") %>'/></del></span><span><asp:Label ID="lblproductdiscount" class="pdis" runat="server" Text='<%# Bind("Order_Discount") %>'/>&#37;<span class="pdisoff">Off</span></span></li>
      <li>
          <asp:LinkButton ID="lnkbtnremove" runat="server" CommandName="removeitem" style=" text-decoration:none;" >Remove</asp:LinkButton></li>
         <asp:Label ID="lblorderid" runat="server" Visible="false" Text='<%#Bind("Order_Id") %>' /> </ul>
    </div>
<div class="col-sm-2">
...
<div class="col-sm-4" style="position:fixed;left:1100px;top:350px;box-shadow: 0px 0px 35px 10px #EEE; z-index:1036; background:#fff">
 <ul>
  <li></li>
   <li><asp:Label ID="Label1" class="pdis" runat="server" Text="Item : "/><span>(<asp:Label ID="lblquantity" class="pdis" runat="server" Text="0"/>)</span><span><asp:Label ID="lblproductpricee" class="pprice" runat="server" Text='<%# Bind("Product_Price") %>'/></span></li>
  ...
  <li><asp:Button ID="btnorderplace" runat="server" class=" savecontinue" 
          Text="Place order" onclick="btnorderplace_Click" 
          /></li>
 </ul>
</div>
